...
for scale in [2.0, 4.0, 6.0, 8.0]:
    os.makedirs(f"/data/guided-diffusion/scale/rbf_ecp_marginal{scale}_128", exist_ok=True)
    noises = []
    datas = []
    classes = []
    for i in range(100):
        file = f'samples/128x128_diffusion/unipc_200_scale{scale}/images/samples_{i}.npz'
