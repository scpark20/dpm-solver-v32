...
python sample_test.py --config=$CONFIG --ckp_path=$CKPT_PATH --sample_folder="lagrange_"$steps --config.sampling.method=lagrange --config.sampling.steps=$steps --config.sampling.eps=$EPS
done