...
from samplers.rbf_ecp_marginal4 import RBFSolverECPMarginal4
...
def get_sampling_fn(config, sde, shape, inverse_scaler, target_matching=False, return_prior=False, scale_dir=None):
